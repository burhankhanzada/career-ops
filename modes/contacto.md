...
1. **Identify targets** via WebSearch:
   ...
   - Assigned Recruiter
   - 2-3 Peer members (people with similar roles)
...
4. **Generate message** using the 3-sentence framework adapted to the contact type:
   ...
   - **Sentence 2 (Proof)**: The candidate's top quantifiable achievement demonstrating they have solved similar problems.
